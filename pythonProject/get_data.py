...
dogs = {}
i = 0
dog = ['Груша', './собака Груша.jpg', 'Собака Груша\nГруше всего 8 месяцев.\n'
...
dogs[dog[0]] = dog
dog = ['Арчи', './пёс Арчи.jpg', 'Пёс Арчи']
dogs[dog[0]] = dog
dog = ['Шарик', 'пёс Шарик.jpeg', 'Пес Шарик дружелюбный и любопытный']
dogs[dog[0]] = dog
...
cats = {}
i = 0
cat = ['Мура', './кошка Мура.jpg', 'Кошка Мура']
cats[cat[0]] = cat
cat = ['Силя', './кот Силя.jpg', 'Кот Силя']
cats[cat[0]] = cat
cat = ['Софа', './кошка Софа.jpg', 'Кошка Софа']
cats[cat[0]] = cat
